...
  </text>
          ...
          <p>&copy; 2010 - 2024, Job Portal Broking Ltd. All rights reserved.</p>
          <br></br>
        ...
        <div className="col ml-10">
          ...
          <br />
          <a href="" style={{textDecoration:"none"}}>Referral programe</a>
          <br />
          <a href="" style={{textDecoration:"none"}}>Carrier</a>
          <br />
          <a href="" style={{textDecoration:"none"}}>Job.tech</a>
          <br />
      ...
      <p>JObBooking Ltd.: Member of NSE, BSE​ &​ MCX – SEBI Registration no.:
      ...
      Commodities Pvt. Ltd. MCX: 46025; NSE-50001 – SEBI Registration no.:
      INZ000038238 Registered Address: Job Broking Ltd., #153/154, 4th
      ...
      securities broking please write to complaints@zerodha.com, for DP related
      to dp@zerodha.com. Please ensure you carefully read the Risk Disclosure
      Document as prescribed by SEBI | ICF</p><p> Procedure to file a complaint on SEBI
      SCORES: Register on SCORES portal. Mandatory details for filing complaints
      on SCORES: Name, PAN, Address, Mobile Number, E-mail ID. Benefits:
      Effective Communication, Speedy redressal of the grievances Smart Online
      Dispute Resolution | Grievances</p> Redressal Mechanism Investments in
      securities market are subject to market risks; read all the related
      documents carefully before investing. <p>Attention investors: 1) Stock
